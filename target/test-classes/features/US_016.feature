...
Feature: US_16 tests
  ...
  Background: user goes gmibank homepage
    ...
    And user logs in with the valid username "Bekir"
    And user logs in with the valid password "Fakirbekir9604,"
  ...
  Scenario: TC1601 User should have at least 2 accounts
    ...
    And user verify Account Type1 "34479"
    And user verify Account Type2 "52486"
