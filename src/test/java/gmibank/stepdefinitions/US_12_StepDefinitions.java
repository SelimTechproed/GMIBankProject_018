...
public class US_12_StepDefinitions {
    ...
    public void benutzer_sieht_und_klickt_auf_die_View() throws InterruptedException {
        us_12_page.viewButton.isEnabled();
