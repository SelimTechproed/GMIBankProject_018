...
public class US_10_Page {
    ...
    public WebElement requiredMessageAdress;

    @FindBy(xpath = "(//div[@class='invalid-feedback'])[9]")
    public WebElement requiredMessageCity;

    @FindBy(partialLinkText = "//div[@class='invalid-feedback']")
    public WebElement requiredMessageCountry;

    @FindBy(xpath = "//div[@class='invalid-feedback']")
    public WebElement requiredMessageState;
