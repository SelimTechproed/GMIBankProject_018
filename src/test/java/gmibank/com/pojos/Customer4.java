...
public class Customer4 {
    ...
    private Country4 country;
    private String state;
    private User4 user;
    private Accounts4 accounts;
    ...
    public void setCountry(Country4 country) {
    ...
    public Accounts4 getAccounts() {
        return accounts;
    }

    public void setAccounts(Accounts4 accounts) {
